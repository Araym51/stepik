...
Создайте класс Robot, у которого есть:
    ...
    1. атрибут класса population. В этом атрибуте будет хранится общее количество роботов, изначально
...
на единицу;
    3. метод destroy, должен уменьшать популяцию роботов на единицу и печатать сообщение вида
