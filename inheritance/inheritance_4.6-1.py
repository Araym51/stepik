"""
  Создайте базовый класс Person, у которого есть:
    1. метод __init__, принимающий имя и возраст человека. Их необходимо сохранить в атрибуты экземпляра name и
age соответственно
...
экземпляра company_name  и location соответственно
  ...
  И в конце создайте класс Employee , который:
    ...
    2. имеет метод __init__, принимающий название имя человека, его возраст, название компании и город основания.
